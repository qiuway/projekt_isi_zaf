...
@app.put("/zamowienia/{zam_id}/przyjmij")
...
@app.put("/zamowienia/{zam_id}/odrzuc")
...
@app.put("/zamowienia/{zam_id}/w_dostawie")
...
@app.put("/zamowienia/{zam_id}/dostarczono")
...
@app.put("/zamowienia/{zam_id}/zaakceptuj-platnosc")
